...
def collect_from_selenium(limit=50, out_path="data/profiles.jsonl"):
    ...
    driver = webdriver.Chrome(service=Service("C:/Users/user/Desktop/Linkedin automation agent/ai-linkedin-agent/src/services/linkedin/chrome-win64/chrome.exe"), options=options)
    try:
